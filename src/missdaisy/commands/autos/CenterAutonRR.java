...
public class CenterAutonRR extends CommandGroup {

  public  CenterAutonRR() {
    ...
    addParallel(new GoToWristAngle(Constants.WristPose.LOAD_CUBE_AUTO, true));
    ...
    */
    ...
    addParallel(new DrivePath("Paths/Center/ToRightScaleFront", -1.0));
