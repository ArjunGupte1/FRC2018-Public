...
public class CubeLoadPosition extends CommandGroup {

  public  CubeLoadPosition() {
    ...
    addSequential(new SetWristAngle(Constants.WristPose.LOAD_CUBE));
    addSequential(new SetArmPose(Constants.ArmPose.LOAD_CUBE, Constants.WristPose.LOAD_CUBE));
  }
}