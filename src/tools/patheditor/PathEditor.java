...
public class PathEditor {
  ...
  String filePath = "src/Auton_2018";
  ...
  Waypoint[] waypoints = new Waypoint[]{new Waypoint(0, 0, 0), new Waypoint(120, 0, 0)};
  ...
  public void Draw2018Field() {
    ...
    File url = new File("src/tools/patheditor/2018HalfField.png");
    ...
    double fx = ConvertLength(27.0, "ft", selectedLengthUnit);
    ...
    double x = ConvertLength(27.0, "ft", selectedLengthUnit);
  ...
  public void SetAxisLimits2018(){
    chartPath.getXYPlot().getRangeAxis().setInverted(true);
    chartPath.getXYPlot().getDomainAxis().setRange(0.0, 652/2.0);
